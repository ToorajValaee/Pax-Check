...
fun PiccScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Tap a contactless card or NFC device on the screen / reader area.",
            ...
            Button(
                ...
                if (isReading) {
                    ...
                    Text("Waiting for Contactless Card...")
                } else {
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    if (piccData != null) {
                        Text(text = "Card Type: ${piccData?.cardType}", style = MaterialTheme.typography.labelMedium, color = MaterialTheme.colorScheme.secondary)
                        Spacer(modifier = Modifier.height(4.dp))
                        Text(
                            text = "UID: ${piccData?.serialNumberHex ?: "N/A"}",
